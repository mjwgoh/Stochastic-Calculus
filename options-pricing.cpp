...
int main() {
    ...
    cout << "Option price at time 0 is: " << option_array[0][0] << endl;

    cout << "Replicating strategy at time 0 is: " << endl;
    cout << "Units of stock: " << replicating_stock_array[0][0] << endl;
    cout << "Value of bond: " << replicating_bond_array[0][0] << endl;
